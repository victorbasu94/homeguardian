  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="pt-32 pb-20 bg-primary-gradient text-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 font-outfit leading-tight">Frequently Asked Questions</h1>
            ...
            <div className="relative max-w-xl mx-auto">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 rounded-full bg-white/10 border border-white/20 text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-white/50"
              />
            </div>
          </div>
        </div>
            ...
            {filteredFAQs.length > 0 ? (
              filteredFAQs.map((faq, index) => (
                ...
                >
                  ...
                  >
                    <h3 className="text-lg font-semibold font-outfit pr-8">{faq.question}</h3>
                  ...
                  >
                    <div className="p-6 pt-0 border-t border-gray-100 font-manrope text-gray-600">
                      {faq.answer}
                    </div>
                  </div>
                </div>
              ...
              <div className="text-center py-12">
                <p className="text-gray-500 text-lg font-manrope">No results found. Try adjusting your search.</p>
                <button 
                  onClick={() => {
                    setSearchQuery('');
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-6 font-outfit text-primary">Still Have Questions?</h2>
            <p className="text-lg mb-8 font-manrope text-gray-600">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a 
                href="/demo" 
                className="bg-white text-primary border border-primary px-6 py-3 rounded-full font-medium hover:bg-gray-50 transition-colors"
              >
                Request a Demo
              </a>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="bg-white p-6 rounded-xl shadow-md text-center hover:shadow-lg transition-shadow">
              <h3 className="text-xl font-bold mb-3 font-outfit">Getting Started</h3>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md text-center hover:shadow-lg transition-shadow">
              <h3 className="text-xl font-bold mb-3 font-outfit">Pricing Plans</h3>
              <p className="text-gray-600 mb-4 font-manrope">
            ...
            <div className="bg-white p-6 rounded-xl shadow-md text-center hover:shadow-lg transition-shadow">
              <h3 className="text-xl font-bold mb-3 font-outfit">Knowledge Base</h3>
              <p className="text-gray-600 mb-4 font-manrope">
                Browse our extensive library of home maintenance articles and tutorials.
              </p>
              <a href="/resources" className="text-primary font-medium hover:underline">
                Explore Resources
              </a>
            </div>
          </div>
