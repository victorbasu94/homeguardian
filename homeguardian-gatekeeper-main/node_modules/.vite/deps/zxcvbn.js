  ...
  "node_modules/zxcvbn/lib/scoring.js"(exports, module) {
    ...
    scoring = {
      nCk: function(n, k2) {
        ...
        r = 1;
        for (d = o = 1, ref = k2; 1 <= ref ? o <= ref : o >= ref; d = 1 <= ref ? ++o : --o) {
          r *= n;
          r /= d;
          n -= 1;
        }
      ...
      most_guessable_match_sequence: function(password, matches, _exclude_additive) {
        var _, bruteforce_update, guesses, k2, l, len, len1, len2, lst, m, make_bruteforce_match, matches_by_j, n, o, optimal, optimal_l, optimal_match_sequence, q, ref, ref1, u, unwind, update, w;
        ...
        matches_by_j = function() {
          var o2, ref2, results;
          results = [];
          for (_ = o2 = 0, ref2 = n; 0 <= ref2 ? o2 < ref2 : o2 > ref2; _ = 0 <= ref2 ? ++o2 : --o2) {
            results.push([]);
          }
          return results;
        }();
        ...
        optimal = {
          m: function() {
            var ref2, results, u2;
            results = [];
            for (_ = u2 = 0, ref2 = n; 0 <= ref2 ? u2 < ref2 : u2 > ref2; _ = 0 <= ref2 ? ++u2 : --u2) {
              results.push({});
            }
            return results;
          }(),
        ...
        update = /* @__PURE__ */ function(_this) {
          return function(m2, l2) {
            var competing_g, competing_l, g, k3, pi, ref2;
            k3 = m2.j;
            pi = _this.estimate_guesses(m2, password);
            if (l2 > 1) {
              pi *= optimal.pi[m2.i - 1][l2 - 1];
            }
            g = _this.factorial(l2) * pi;
            if (!_exclude_additive) {
              g += Math.pow(MIN_GUESSES_BEFORE_GROWING_SEQUENCE, l2 - 1);
            }
            ref2 = optimal.g[k3];
            ...
            optimal.g[k3][l2] = g;
            optimal.m[k3][l2] = m2;
            return optimal.pi[k3][l2] = pi;
          };
        }(this);
        bruteforce_update = /* @__PURE__ */ function(_this) {
          return function(k3) {
            var i, l2, last_m, ref2, results, u2;
            m = make_bruteforce_match(0, k3);
            update(m, 1);
            results = [];
            for (i = u2 = 1, ref2 = k3; 1 <= ref2 ? u2 <= ref2 : u2 >= ref2; i = 1 <= ref2 ? ++u2 : --u2) {
              m = make_bruteforce_match(i, k3);
        ...
        make_bruteforce_match = /* @__PURE__ */ function(_this) {
          return function(i, j) {
            return {
              pattern: "bruteforce",
        ...
        unwind = /* @__PURE__ */ function(_this) {
          return function(n2) {
            var candidate_g, candidate_l, g, k3, l2, optimal_match_sequence2, ref2;
            ...
            while (k3 >= 0) {
              m = optimal.m[k3][l2];
              optimal_match_sequence2.unshift(m);
              k3 = m.i - 1;
              l2--;
            }
        ...
        for (k2 = u = 0, ref = n; 0 <= ref ? u < ref : u > ref; k2 = 0 <= ref ? ++u : --u) {
          ref1 = matches_by_j[k2];
      ...
      MIN_YEAR_SPACE: 20,
      REFERENCE_YEAR: (/* @__PURE__ */ new Date()).getFullYear(),
      ...
      uppercase_variations: function(match) {
        ...
        U = function() {
          var len1, q2, ref12, results;
          ref12 = word.split("");
          results = [];
          for (q2 = 0, len1 = ref12.length; q2 < len1; q2++) {
            chr = ref12[q2];
            if (chr.match(/[A-Z]/)) {
              results.push(chr);
            }
      ...
      l33t_variations: function(match) {
        ...
        for (subbed in ref) {
          ...
          S = function() {
            var len, o2, results;
            results = [];
            for (o2 = 0, len = chrs.length; o2 < len; o2++) {
              chr = chrs[o2];
              if (chr === subbed) {
                results.push(chr);
              }
    ...
    matching = {
      ...
      enumerate_l33t_subs: function(table) {
        ...
        dedup = function(subs2) {
          var assoc, deduped, label, len12, members, o2, sub2, v;
          deduped = [];
          members = {};
          for (o2 = 0, len12 = subs2.length; o2 < len12; o2++) {
            sub2 = subs2[o2];
            assoc = function() {
              var len22, p2, results;
              results = [];
              for (v = p2 = 0, len22 = sub2.length; p2 < len22; v = ++p2) {
                k = sub2[v];
                results.push([k, v]);
              }
              return results;
            ...
            label = function() {
              var len22, p2, results;
              results = [];
              for (v = p2 = 0, len22 = assoc.length; p2 < len22; v = ++p2) {
                k = assoc[v];
                results.push(k + "," + v);
              }
              return results;
        ...
        helper = function(keys2) {
          var dup_l33t_index, first_key, i, l33t_chr2, len12, len22, next_subs, o2, p2, q, ref2, ref1, rest_keys, sub2, sub_alternative, sub_extension;
          if (!keys2.length) {
            return;
          }
          first_key = keys2[0];
          ...
          for (o2 = 0, len12 = ref2.length; o2 < len12; o2++) {
            l33t_chr2 = ref2[o2];
            for (p2 = 0, len22 = subs.length; p2 < len22; p2++) {
              sub2 = subs[p2];
              dup_l33t_index = -1;
              for (i = q = 0, ref1 = sub2.length; 0 <= ref1 ? q < ref1 : q > ref1; i = 0 <= ref1 ? ++q : --q) {
                if (sub2[i][0] === l33t_chr2) {
                  dup_l33t_index = i;
                  break;
                }
              }
